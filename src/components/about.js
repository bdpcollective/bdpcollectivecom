...
const About = () => {
    return (
        <>
            <p className={aboutStyles.connectaha}>I am Principal UX Designer at <a href="https://www.devobsessed.com/">DevObsessed</a> in Omaha. With over 20 years of design experience I have seen a variety of different projects, processes and teams. I am passionate about understanding the "Why" behind design, teamwork within the technology space and the education of design.</p>
